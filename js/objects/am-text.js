class AMText extends AMObject {
    ...
    updateElement() {
        ...
        this.el.style.fontStyle = ( this.props.style.values[1].checked.includes(this.values.style) ) ? 'italic' : ''
        this.el.style.textDecoration = ( this.props.style.values[2].checked.includes(this.values.style) ) ? 'underline' : ''
    }
